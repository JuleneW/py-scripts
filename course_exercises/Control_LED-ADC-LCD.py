...
try:
    ...
    while True:
        ...
        transistor_value = int(tmp0 * 100/1023)
        wiringpi.digitalWrite(LED_PIN, transistor_value)

        lcd_1.clear()
        lcd_1.go_to_xy(0, 0)
        lcd_1.put_string('Pot value:' + str(tmp0))
        lcd_1.go_to_xy(0, 10)
        lcd_1.put_string('LED:' + str(transistor_value) + '%')
        lcd_1.refresh()
